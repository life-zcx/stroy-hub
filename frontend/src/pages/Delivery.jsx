        ...
        <div className="bg-white border border-slate-200/60 rounded-3xl p-6 sm:p-8 shadow-sm space-y-6">
          ...
          <div className="space-y-5 text-sm">
            ...
            <div className="space-y-2">
              ...
              <p className="text-slate-500 text-xs leading-relaxed">
                Все платежи защищены. Денежные средства резервируются на платформе StroyHub и переводятся поставщику только после подтверждения успешного приема товара клиентом.
              </p>
            </div>
          </div>
        </div>
