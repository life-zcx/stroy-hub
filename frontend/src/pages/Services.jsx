...
export default function Services({ onOpenCallback }) {
  ...
  const services = [
    ...
    },
    {
      ...
      longDesc: "Надежные партнерские службы логистики позволяют организовывать доставку грузов любой сложности и объема в режиме 24/7. Для перевозок привлекаются манипуляторы различной грузоподъемности, самосвалы и длинномеры. Мы гарантируем точное соблюдение сроков доставки, чтобы ваш объект не простаивал ни минуты.",
      benefits: [
        "Проверенная сеть партнерской спецтехники",
