          ...
          <table className="w-full text-left text-xs border-collapse">
            <tbody>
              ...
              <tr className="border-b border-slate-100">
                ...
                <td className="py-3 pl-4 font-mono font-bold text-slate-900">260540019284</td>
              </tr>
              <tr className="border-b border-slate-100">
              ...
              <tr className="border-b border-slate-100">
                ...
                <td className="py-3 pl-4 font-mono font-bold text-slate-900">KZ859261827495018273</td>
              </tr>
              <tr className="border-b border-slate-100">
