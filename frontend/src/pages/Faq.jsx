...
export default function Faq() {
  ...
  const faqs = [
    ...
    {
      q: "Что такое безопасная сделка на StroyHub?",
  ...
  return (
    <div className="max-w-3xl mx-auto animate-fade-in-up space-y-12 font-sans text-slate-800 text-left">
      <div className="space-y-3">
        ...
        <p className="text-slate-500 text-sm">Часто задаваемые вопросы о покупках, логистике и документообороте на StroyHub</p>
      </div>
