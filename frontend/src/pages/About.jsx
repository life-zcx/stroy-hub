  ...
  return (
    <div className="max-w-4xl mx-auto animate-fade-in-up space-y-12 font-sans text-slate-800 text-left">
      ...
      <div className="space-y-3">
        <h1 className="text-3xl md:text-4xl font-extrabold tracking-tight text-slate-900 font-outfit">О платформе StroyHub</h1>
      ...
      <div className="bg-white border border-slate-200/60 rounded-3xl p-8 sm:p-10 shadow-sm space-y-6">
        ...
        <p className="text-slate-600 text-sm leading-relaxed">
          StroyHub — это современная технологическая платформа, созданная для оптимизации цепочки поставок строительных материалов на рынке Казахстана. Мы напрямую объединяем конечных покупателей (как частных застройщиков, так и крупные подрядные организации) с авторизованными складами заводов-производителей.
        </p>
        <p className="text-slate-600 text-sm leading-relaxed">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <a href="tel:88005553535" className="text-white hover:text-emerald-400 transition-colors text-xs font-bold">8 (800) 555-35-35</a>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <span className="text-slate-400 text-xs">partner@stroy-hub.kz</span>
              </div>
            </div>
            <div className="flex items-start gap-3">
