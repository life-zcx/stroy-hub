...
export default function ProductsPage({
  ...
  const handleDownloadTemplate = () => {
    ...
    const exampleRow = [
      'Экструдированный пенополистирол Пеноплекс Комфорт 50 мм',
      '9800',
      'Доски обрезные',
      'Пеноплекс',
      'PNP-50-K',
      'Универсальный утеплитель нового поколения для дома.',
      'Теплоизоляционный материал, изготовленный методом экструзии. Обладает высокими теплоизоляционными свойствами.',
      'Толщина: 50 мм\nТип кромки: Г-образная\nПлотность: 25-35 кг/м³',
      '1. Подготовить основание\n2. Нанести клей\n3. Закрепить плиты',
      '10500',
      'да',
      'penoplex-comfort-50mm'
    ];
